#!/bin/bash
# ============================================================
# Dispatcher — AI Trading Research (5 tareas paralelas)
# Adaptado de dispatcher_v3.sh para sesión tmux "1"
# Workers: ventanas 1,2,3,4,5 (coordinador: ventana 0)
# ============================================================

set -euo pipefail

TASKS_FILE="/Users/admin/plugins/dispatch/tasks_ai_trading.txt"
INTERVAL=60
NUM_WORKERS=5
TMUX_SESSION="1"
...
is_session_idle() {
    ...
    # Prompt vacío ❯ o indicador de bypass permissions = idle
...
main_loop() {
    ...
    log "============================================================"
    log "DISPATCHER AI TRADING RESEARCH INICIADO"
    log "Tareas: $total_tasks | Workers: ${#WORKER_WINDOWS[@]} | Intervalo: ${INTERVAL}s"
    log "Session tmux: $TMUX_SESSION | Ventanas: ${WORKER_WINDOWS[*]}"
    log "============================================================"
...
log "Dispatcher AI Trading terminado (PID $$)"
rm -f "$PID_FILE"
